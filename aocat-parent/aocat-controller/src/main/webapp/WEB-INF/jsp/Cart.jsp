...
<body>
	...
	<header>
		<div class="head w1190">
			<div class="headLeft">
				<div class="loginuser">
					<a href="#"> <span>您好，${user.name }</span> <span>|</span>
					</a>
				</div>
				<div class="loginout">
	...
	<div class="indent boxS">
		<div class="indentAea w1190">
			...
			<div class="IAbd">
				...
				<c:forEach items="${glist }" var="items">
					<ul class="IAbdArea">
						<li class="IAbdw"><span class="lincheck checkbox"></span> <img
							src="static/images/${items.img }" alt="">
							<p>
								<a class="pro" href="#">${items.name }</a> <a class="use"
							...
							<ul class="IAul">
								...
								<li class="num"><span class="reduce">-</span> <input
									...
									class="add">+</span></li>
								<li class="Lastprice">¥ <u>${items.price}</u></li>
								<li class="last btn">
									<button>移入收藏夹</button>
									<br> <input id="shopid" type="hidden"
									value="${items.itemid }">
				...
				<div class="IAbdfoot">
					<span class="checkbox Allcheck"></span> <span>全选</span> <span
						class="Information">删除选中商品</span> <a id="tocal"
						href="getAmount?uid=${user.id }">去结算</a>
					<p>
						<strong>已选商品<b id="allnum"> 1 </b>件
						</strong> <strong>总价（不含运费）：<b>￥<u id="allpri">114.00</u></b></strong><br>
						<em>活动优惠 ：-￥<u>0.00</u></em> <em>商品应付总计 ：￥<u>114.00</u></em> <em>订单关税：￥<u>0</u></em>
					</p>
				</div>
			</div>
		</div>
